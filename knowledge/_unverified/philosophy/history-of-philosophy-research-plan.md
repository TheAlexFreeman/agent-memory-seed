...
## Proposed file structure: `knowledge/_unverified/philosophy/history/`
...
### Phase 1 — The Greek Foundation (highest priority)
...
### Phase 2 — The Medieval Synthesis (high priority)
...
### Phase 3 — Early Modern: The Break (high priority)
...
11. `early-modern/kant.md` (warrants its own file)
    ...
    - The synthetic a priori — connect explicitly to Alex's question in this session
...
### Phase 4 — Nineteenth Century: Responses to Kant (high priority)
...
### Phase 5 — Twentieth Century: The Great Bifurcation (high priority)
...
### Phase 6 — Non-Western Traditions (high priority, usually underweighted)
...
### Phase 7 — Contemporary Philosophy (medium priority — will emerge naturally from the above)
...
## Synthesis files (to write after period files are complete)
...
- Non-Western traditions: resist the temptation to organize them purely in relation to Western development. Each should be introduced on its own terms with internal development before noting connections.
- Sources: use WebSearch for recent scholarship; for primary texts, the Stanford Encyclopedia of Philosophy (plato.stanford.edu) is reliable and usually accessible. Note trust: low on all externally sourced content.
- Connection: each file should cross-reference adjacent files and the existing philosophy cluster (`synthesis-intelligence-as-dynamical-regime.md`, `narrative-cognition.md`, `cognitive-linguistics-metaphor-blending.md`, etc.) where relevant.

## Starting points for the next session

Begin with Phase 1 in order: pre-Socratics → Plato → Aristotle → Hellenistic. These are also the files that will generate the most downstream connections to everything else.
