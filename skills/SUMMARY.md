...
- **[codebase-survey.md](codebase-survey.md)** — Systematic host-repo exploration for a new worktree-backed memory store. Use when `plans/codebase-survey.md` is active or when a codebase knowledge skeleton still contains template stubs.
