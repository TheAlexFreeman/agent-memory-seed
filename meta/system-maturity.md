...
5. **Log all transitions and close calls** in both this file's assessment log and in `meta/CHANGELOG.md`. A "close call" (3-3 split that was resolved by tiebreaker) is worth noting so future assessments can see the trend.
