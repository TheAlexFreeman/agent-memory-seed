...
Scope: Restore the returning-session path to a real compact operating mode and add enforcement that prevents drift.
Progress: 16/22 complete
Next: Phase 3, item 5 — add drill-down reference checks to keep compact summaries pointing at deeper files instead of duplicating them
