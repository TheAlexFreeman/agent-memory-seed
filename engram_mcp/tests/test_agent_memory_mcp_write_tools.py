...
""",
        ...
        self.assertIn("**[alpha-note.md](alpha-note.md)** -- Alpha is the first concise summary paragraph.", output)
...
""",
        ...
        self.assertIn("Metadata: trust: medium; source: agent-generated; verified: 2026-03-20.", output)
